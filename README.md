...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0-0a2a0a,50-1a4a1a,100-0d3a0d&height=200&section=header&text=Luisa%20Campanha&fontSize=52&fontAlignY=38&animation=fadeIn&fontColor=d4af37&desc=Fullstack%20Developer%20%7C%20CS%20Student&descAlignY=58&descSize=22&descColor=d4af37" />
...
🇧🇷 Brazilian developer based in Belo Horizonte &nbsp;•&nbsp; 🌍 Eyes set on Canada & Europe🌍 Eyes set on Canada & Europe
...
Currently focused on mastering the modern fullstack: **TypeScript, React/Next.js, Node.js, Spring Boot** and data analysis with **Python**. Actively looking for internship opportunities in tech — banking, fintech, or multinational companies.
